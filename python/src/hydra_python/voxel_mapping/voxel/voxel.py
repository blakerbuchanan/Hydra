...
import voxel_mapping.utils.logger as logger
from voxel_mapping.core.interfaces import Observations
from voxel_mapping import Parameters
from voxel_mapping import GridParams
# from voxel_mapping.instance import Instance, InstanceMemory

from voxel_mapping.utils.data_tools.dict import update

from voxel_mapping.utils.morphology import binary_dilation, binary_erosion, get_edges
from voxel_mapping.utils.point_cloud import create_visualization_geometries, numpy_to_pcd

from voxel_mapping.utils.point_cloud_torch import unproject_masked_depth_to_xyz_coordinates
from voxel_mapping.utils.visualization import create_disk
from voxel_mapping.utils.voxel import VoxelizedPointcloud, scatter3d
from voxel_mapping.motion.base import PlanResult
...
class SparseVoxelMap(object):
    ...
    def get_instances_as_dict(self):
    ...
    def add_obs(
        ...
        **kwargs,
        ...
        base_pose = torch.from_numpy(np.array([obs.gps[0], obs.gps[1], obs.compass])).float()
    ...
    def xyt_is_safe(self, xyt: np.ndarray, robot = None) -> bool:
