...
class VLMPLannerEQAGPTSAYPLAN:
    ...
    def agent_role_prompt(self):
        ...
        prompt = f'''You are an excellent hierarchical graph planning agent. 
            ...
            If you are unable to answer the question with high confidence, and need more information to answer the question, then you can take steps in the environment: Goto_object_node_step 
            ...
            While choosing the above actions, play close attention to 'HISTORY' especially the previous 'Action's to see if you have taken the same action at previous timesteps. 
            Avoid going to the same object again and again.
        ...
        while not succ:
            try:
                ...
                completion = client.beta.chat.completions.parse(
                    ...
                    messages=messages,
                    response_format=create_planner_response(room_node_list, object_node_list, Answer_options),
                )
